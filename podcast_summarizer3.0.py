...
downloads_folder = os.path.expanduser('/Users/nelsonestrada/projects/podcast_summarizer/journal_reels/')
local_file_path = os.path.join(downloads_folder, 'Gracia.mp4')
